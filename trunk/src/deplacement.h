...
/**
* \brief Preconditions : 0<=y<TAILLE_MAX_H
...
/**
* \brief Preconditions : 0<=x<TAILLE_MAX_L
* <br /> Postconditions : vérifie l'accessibilité de la case x de tab : retourne 0 si inaccessible, 1 sinon.
*/
